...
const ServiceModal = ({ isOpen, onClose, service }: ServiceModalProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-gray-900/80 backdrop-blur-sm transition-opacity duration-500"
        onClick={onClose}
      >
      ...
      <div
        className="relative bg-white rounded-3xl max-w-4xl w-full mx-auto max-h-[90vh] overflow-hidden transform transition-all duration-500 scale-95 hover:scale-100 shadow-2xl service-modal-panel border border-gray-200"
