...
const RecyclingCalculator = () => {
  ...
  const calculateImpact = async () => {
    ...
    setResult(
      `Recycling ${weight} kg of ${metalType} saves approximately ${co2Savings.toFixed(1)} kg of CO2 emissions and ${treesSaved} trees!`,
    );
  ...
  return (
    <div
      className="max-w-lg mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-2"
      data-aos="fade-up"
    >
      {/* Header */}
      <div className="bg-gradient-to-r from-royal-blue-600 to-electric-blue-600 p-6 text-white">
        ...
        <p className="text-blue-100">
          See how your recycling makes a difference
        </p>
      </div>
      ...
      <div className="p-6">
              ...
              <button
                ...
                className={`p-4 rounded-xl border-2 transition-all duration-300 ${
                  metalType === metal.value
                    ? `border-royal-blue-500 bg-gradient-to-r ${metal.color} text-white shadow-lg transform scale-105`
                    : "border-gray-200 hover:border-royal-blue-300 hover:bg-royal-blue-50"
                }`}
              >
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <input
              ...
              className="w-full p-4 border-2 border-gray-200 rounded-xl focus:border-royal-blue-500 focus:ring-2 focus:ring-royal-blue-200 transition-all duration-300 text-lg font-semibold"
        ...
        <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl">
          ...
          <p className="text-gray-600 text-sm">
            Recycling one aluminum can saves enough energy to power a TV for 3
            hours!
          </p>
        </div>
      </div>
