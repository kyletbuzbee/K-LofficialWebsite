...
const ResourcesPage: FC = () => {
  const faqs = [
    {
      ...
      answer:
        "We accept all types of ferrous metals (steel, iron, cast iron) and non-ferrous metals (copper, aluminum, brass, stainless steel, lead, zinc, nickel). This includes appliances, car parts, metal furniture, wire, pipes, and more.",
    },
    {
      question: "Do I need an appointment to drop off scrap metal?",
      answer:
        "No appointment is necessary for public drop-offs. Our facilities are open Monday through Friday 7AM-5PM and Saturday 8AM-3PM. Just drive onto our scale and our staff will assist you.",
    },
    {
      question: "How do you determine the price for my scrap metal?",
      answer:
        "Prices are based on current market values, material type, weight, and condition. We use certified scales and provide transparent pricing. You'll receive immediate payment based on accurate weight and current market rates.",
    },
    {
      question: "Do you offer pickup services?",
      answer:
        "Yes, we offer pickup services for industrial customers and large quantities. We provide roll-off containers, scheduled pickups, and can coordinate with your production schedule. Contact us to discuss your specific needs.",
    },
    {
      question: "Are your facilities environmentally compliant?",
      answer:
        "Absolutely. All our facilities operate in full compliance with EPA regulations and local environmental standards. We're committed to responsible recycling practices and environmental stewardship.",
    },
    {
      question: "What happens to the metal after I sell it?",
      answer:
        "The metal is processed, sorted by type, and sent to mills and foundries where it's melted down and made into new products. This creates a sustainable recycling loop that conserves natural resources.",
    },
  ];
  ...
  const guides = [
    ...
    },
    {
      ...
      description:
        "Tips on cleaning and preparing your scrap metal to get the best prices",
    ...
    },
    {
      ...
      description:
        "Understanding the environmental impact and benefits of recycling metal",
  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Access recycling guides, frequently asked questions, industry news, and educational resources from K&L Recycling experts."
        />
      ...
      <section className="bg-gradient-to-br from-gray-900 to-royal-blue-900 text-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
            Everything you need to know about scrap metal recycling, from guides
            and tips to industry news and FAQs.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <Link
              href="#faq"
              className="group bg-gradient-to-br from-royal-blue-50 to-electric-blue-50 rounded-2xl p-6 text-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
            >
            ...
            <Link
              href="#guides"
              className="group bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 text-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
            >
            ...
            <Link
              href="#blog"
              className="group bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-6 text-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
            >
            ...
            <Link
              href="/contact"
              className="group bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 text-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
            >
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get answers to the most common questions about scrap metal
              recycling
            </p>
          </div>
      ...
      <section id="guides" className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Learn how to maximize your recycling value with our expert guides
            </p>
          </div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-royal-blue-600 font-semibold hover:text-royal-blue-700 cursor-pointer">
                      Read Guide →
                    </span>
                  </div>
                </div>
      ...
      <section id="blog" className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Stay updated with industry news, company updates, and recycling
              insights
            </p>
          </div>
            ...
            {allPosts.slice(0, 6).map((post, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-royal-blue-700 transition-colors">
                    {post.title}
                  </h3>
