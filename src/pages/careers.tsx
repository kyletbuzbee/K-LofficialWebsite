  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Join the K&L Recycling team and build a career in a vital industry."
        />
      </Head>
      ...
      <section className="bg-gray-800 text-white py-20">
        ...
        >
          ...
          <p className="text-xl md:text-2xl mt-4 max-w-3xl mx-auto">
            Build a rewarding career at K&L Recycling and help us create a more
            sustainable future.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto">
            {jobOpenings.map((job, index) => (
              <div
                key={index}
                className="bg-gray-50 p-6 rounded-lg shadow-md mb-6 flex justify-between items-center"
                data-aos="fade-up"
